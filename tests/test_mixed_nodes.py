...
from cannonball.nodes import BlockingNode, Thought, Task, Question, Goal, Problem, TaskType
...
class TestMixedNodes(unittest.TestCase):
    ...
    def test_tree_structure_with_mixed_nodes(self):
        ...
        graph.add_nodes_from(
            [root_task, branch1_question, branch1_task, branch2_goal, branch2_problem, branch3_thought]
        )
